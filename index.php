...
if (isset($_GET['id']) && isset($_GET['qnt'])) {
    $scrollToProductSection = 1;
} else {
    $scrollToProductSection = 0;
}
?>
            ...
            <div class="col-xl-7 col-lg-8 offset-xl-5 offset-lg-4">
                <div class="office-pera" id="office-pera">
                    <div class="section-tittle">
                        ...
                        <img id="imagem_homepage" sizes="(max-width: 930px) 100vw, 930px"
srcset="
background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_200.webp 200w,
background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_486.webp 486w,
background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_676.webp 676w,
background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_883.webp 883w,
background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_930.webp 930w"
src="background_mobile_example_short_zcn3gr_ar_1_1,c_fill,g_auto__c_scale,w_930.webp" loading="lazy" style="width: 100%; display: none;">
...
<div class="video-container" style="position: relative; width: 100%; height: 70vh; overflow: hidden;" id="video-container-pc">
    <!-- Video tag -->
                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        <div class="image-icons-container" style="text-align: center;">
                            ...
                            <div class="card_type_buttons" style="display: flex; align-items: center; justify-content: center;">
                                <button class="platform-icon-new" data-id="1" style="border: none;border-radius: 50%; padding: 0;overflow: hidden;background-image: none;margin-right: 12px; cursor: pointer;">
                                    <img src="google-logo.png" alt="Google Icon" style="width: 70px; height: 100%; display: block;">
                                </button>
                                ...
                                <button class="platform-icon-new" data-id="4" style="border: none;border-radius: 50%; padding: 0;overflow: hidden;background-image: none;margin-right: 12px; cursor: pointer;">
                                    <img src="tripadvisor.png" alt="TripAdvisor Icon" style="width: 70px; height: 100%; display: block;">
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5" style="font-size: 19px; margin-bottom: 0 !important; display: inline-block;">
                            ...
                            <sup id="product_extra_price_display" class="badge badge-danger" style="text-decoration: line-through;font-weight: 500;font-size: 13px;text-decoration: line-through;text-decoration-thickness: 1.1px; /* font-family: 'Work Sans'; */
                            "><?php if (!empty($extra_price)) { echo $extra_price." ".$currency; } ?></sup>
                            <!--
                        ...
                        <div class="star-rating" style="line-height: 19px; margin-bottom: 5%;">
                            ★ ★ ★ ★ ★
                        </div>
                        ...
                        <div>
                            ...
                            <div class="btn-group btn-group-toggle-index d-flex flex-column flex-sm-row text-center" style="flex-direction: column !important;">
                                <button class="btn btn-outline-secondary btns_packs" style="background-image: none !important; padding-left: 6% !important; padding-right: 6% !important; border-radius: 0;" data-qnt="1">
                                    ...
                                    <p style="margin: 0;color: white;font-weight: 800;"><?php echo translate('pack_1_qnt'); ?> | <span class="badge badge-danger">16.95<?php echo $currency; ?></span></p>
                                </button>
                                <button class="btn btn-outline-secondary btns_packs" style="background-image: none !important; padding-left: 6% !important; padding-right: 6% !important; border-radius: 0;" data-qnt="5">
                                    <span style="font-weight: 800;font-size: 16px;"><?php echo translate('pack_2_title'); ?></span> <hr style="margin: 0%; padding: 1%;"> <p style="margin: 0;color: white;font-weight: 800;"><?php echo translate('pack_2_qnt'); ?> | <span class="badge badge-danger">49.95<?php echo $currency; ?></span></p>
                                </button>
                                <button class="btn btn-outline-secondary btns_packs" style="background-image: none !important; padding-left: 6% !important; padding-right: 6% !important; border-radius: 0;" data-qnt="10">
                                    <div class="flashing-text">Best Offer!</div>
                                     <span style="font-weight: 800;font-size: 16px;"><?php echo translate('pack_3_title'); ?></span> <hr style="margin: 0%; padding: 1%;"> <p style="margin: 0;color: white;font-weight: 800;"><?php echo translate('pack_3_qnt'); ?> | <span class="badge badge-danger">79.95<?php echo $currency; ?></span></p>
                                ...
                                <button class="btn btn-outline-secondary btns_packs" style="background-image: none !important; padding-left: 6% !important; padding-right: 6% !important; border-radius: 0;" data-qnt="20">
                                    <span style="font-weight: 800;font-size: 16px;"><?php echo translate('pack_4_title'); ?></span> <hr style="margin: 0%; padding: 1%;"> <p style="margin: 0;color: white;font-weight: 800;"><?php echo translate('pack_4_qnt'); ?> | <span class="badge badge-danger">119.95<?php echo $currency; ?></span></p>
                                </button>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-duration="0.7s" data-wow-delay=".2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInUp;" >
                    <div class="single-card text-center mb-30">
                        ...
                        <div class="card-bottom">
                            ...
                            <a href="#product_section" class="borders-btn triggerButton" data-qnt="5"><?php echo translate('section_5_packs_btn'); ?></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-duration="0.7s" data-wow-delay=".2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInUp;" >
                    <div class="single-card text-center mb-30">
                        ...
                        <div class="card-bottom">
                            ...
                            <a href="#" class="borders-btn triggerButton" data-qnt="10"><?php echo translate('section_5_packs_btn'); ?></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-duration="0.7s" data-wow-delay=".2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInUp;" >
                    <div class="single-card text-center mb-30">
                        ...
                        <div class="card-bottom">
                            ...
                            <a href="#product_section" class="borders-btn triggerButton" data-qnt="20"><?php echo translate('section_5_packs_btn'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
